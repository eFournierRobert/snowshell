 ...
 *        It detects things like arrow keys or key combination and deals with
 * them automatically.
 *
 ...
 *
 * @warning If it returns 0, it doesn't mean that input will have anything in
 * it. It only means that the enter key was pressed. Empty input should be dealt
 * with.
 */
